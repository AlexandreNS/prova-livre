...
import { Box, Button, Card, Divider, Dropdown, Grid, ListItem, Scrollable, Text, Tooltip } from '@react-bulk/web';
    ...
    <Box component="header" bg="background" borderBottom="1px solid gray.main.25" p="1gap">
      ...
      <Dropdown r={0} t={0} visible={isUserMenuVisible} onClose={() => setIsUserMenuVisible(false)}>
        <Card w={320}>
          ...
          <Box center>
            <Box center bg={color(user?.email)} borderRadius={30} h={60} w={60}>
